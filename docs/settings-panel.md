...
| General | **Master controls** · **Capture** · **Interface** · **History** · **Filters** | 8 · 4 · 3 · 1 · 1 |
...
cannot reach those eight paths. `/bl get` still can — `Schema:Get` falls through to the stored value —
