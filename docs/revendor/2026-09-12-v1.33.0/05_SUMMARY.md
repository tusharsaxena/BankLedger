...
- `CLAUDE.md:46`, the provenance line.
- `docs/testing.md:93`–`:94`, the sibling-checkout state sentence.
...
|---|---|---|---|
| Before the copy | 871 passed, 0 failed, 0 skipped, 871 total | 0 / 0 in 61 files | clean, no function above CCN 15 |
| After the copy, the roll and the comments | 871 passed, 0 failed, 0 skipped, 871 total | 0 / 0 in 61 files | clean, no function above CCN 15 |
